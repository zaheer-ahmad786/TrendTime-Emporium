...
@section('content')
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('admin.category.store',$brand->id) }}" method="POST"
                    ...
                    <fieldset class="Sku">
                        ...
                        <input class="flex-grow" type="text" placeholder="Sku" name="sku" tabindex="0"
                    ...
                    <fieldset class="description">
                        ...
                        <input class="flex-grow" type="text" placeholder="description" name="description" tabindex="0"
                            value="{{ old('description') }}" aria-required="true">
                    </fieldset>
                    @error('description')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                    @enderror
                    <fieldset class="price">
                        <div class="body-title">Categories Price <span class="tf-color-1">*</span></div>
                        <input class="flex-grow" type="text" placeholder="Price" name="price" tabindex="0"
